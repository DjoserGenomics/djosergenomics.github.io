...
Here is a list of all of my HTGAA 2025 Assignments:

> I will be updating this list as I complete more assignments throughout the course.

| Week | Homework Link                                                                                       |
| ---- | --------------------------------------------------------------------------------------------------- |
| 1    | [Week 1: Principles and Practices]({{site_baseurl}}/Field-Note-08-Dispatch-HTGAA-Week-1-Homework/)  |
| 2    | [Week 2: DNA Read, Write, and Edit]({{site_baseurl}}/Field-Note-09-Dispatch-HTGAA-Week-2-Homework/) |
